...
from trt_trf.nndf.tensorrt_utils import TRTNativeRunner
from trt_trf.nndf.general_utils import NNFolderWorkspace
from trt_trf.t5.frameworks import T5FHuggingFace
from trt_trf.t5.T5ModelConfig import T5ModelTRTConfig
from trt_trf.t5.measurements import decoder_inference, encoder_inference, full_inference_greedy
from trt_trf.t5.export import T5DecoderONNXFile, T5EncoderONNXFile
from trt_trf.nndf.models import TRTEngineFile
...
class T5TRTDecoder(TRTHFRunner):
    ...
    def forward(self, input_ids, encoder_hidden_states, *args, **kwargs):
        ...
        if not getattr(self, 'return_device', None): self.set_return_device("cpu")
